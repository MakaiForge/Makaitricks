...
_prefix_path = os.path.abspath(
    os.path.join(os.path.dirname(__file__), *([".."] * 6), "tools", "prefix", "python")
)
...
from prefix.makaitricks import install_recommended_dlls  # noqa: E402,F401

__all__ = ["create_prefix", "delete_prefix", "install_recommended_dlls"]
