...
export const getDownloadersForUri = (uri: string) => {
  if (
    uri.startsWith("https://gofile.io") ||
    uri.includes(".gofile.io")
  ...
  if (
    ...
    uri.startsWith("https://ts.buzzheavier.com") ||
    uri.startsWith("https://fafda.to") ||
  ...
  if (uri.startsWith("magnet:")) {
    return [Downloader.Torrent, Downloader.Nimbus];
  }
