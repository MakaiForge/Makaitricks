...
export class PythonRPC {
  ...
  private static spawnDisabled = false;

  static isSpawnDisabled(): boolean {
    return this.spawnDisabled;
  }
  ...
  public static async spawn(
    ...
    const usePackagedRpc =
      app.isPackaged || process.env.USE_PACKAGED_RPC === "true";
    if (usePackagedRpc) {
